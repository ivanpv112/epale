...
<head>
    ...
    <title>Importar Diagnósticos | Admin E-PALE</title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="page-title-center" style="margin-bottom: 30px;">
            <h1><i class="fas fa-clipboard-check"></i> Carga Masiva de Exámenes Diagnósticos</h1>
            <p>Sube el archivo CSV para alimentar el historial de resultados de los estudiantes.</p>
        </div>
        ...
        <div class="import-section">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                ...
                <button type="button" class="btn-cancel" onclick="toggleExcel('excelDiagnosticos')" style="background: #107c41; color: white; border: none; padding: 6px 12px; font-size:0.85rem;"><i class="fas fa-file-excel"></i> Ver ejemplo visual</button>
            </div>

            <div class="excel-table-wrapper" id="excelDiagnosticos" style="display: block;">
                    ...
                    <table class="excel-table">
                        <thead>
                            ...
                            <tr> 
                                ...
                                <th>CODIGO</th> 
                                <th>IDIOMA</th> 
                                <th>NIVEL_ASIGNADO</th> 
                                <th>CALIFICACION_TEXTUAL</th> 
                                <th>PERIODO</th> 
                ...
                <div class="excel-info-box"><i class="fas fa-info-circle" style="color:var(--udg-blue);"></i> <strong>Puntos Clave:</strong> 1. El alumno ya debe existir en el sistema. 2. El <strong>NIVEL_ASIGNADO (Col. C)</strong> debe ser un número entero. 3. El formato de <strong>Fecha (F)</strong> debe ser <strong>DD/MM/AAAA</strong>.</div>
            </div>

            <form method="POST" action="importar_diagnosticos" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn-save" id="btnDiagnosticos" disabled style="width: 100%; justify-content: center; background-color: #ccc; cursor: not-allowed;"><i class="fas fa-upload"></i> Procesar Archivo de Diagnósticos</button>
            </form>
        </div>
