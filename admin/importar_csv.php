        ...
        <div class="import-section">
            ...
            <div class="help-box">
                ...
                <p style="margin-top: 10px; font-size: 0.85rem; color: #666;">
                    <i class="fas fa-lightbulb"></i> <strong>Nota:</strong> Debe incluirse explícitamente la columna <strong>Apellido Paterno</strong> y <strong>Apellido Materno</strong>. No se realizará división automática.
                </p>
            </div>
        </div>
    </div>
